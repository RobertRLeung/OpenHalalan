...
| `City` | string | City / municipality, for the **municipal** offices (mayor, vice mayor, councilor). From **2016** on it is the canonical name off a scraped ballot (matching `city` in the vote-counts dataset). **2001–2013 come from COMELEC's List of Elected Candidates**, which prints the town — recovered for 2004–2013 by matching each winner to that year's list on province + surname + given (the inherited v8.5 source those cycles came from had no town). Blank for provincial and district offices (a governor has no city) and for the small tail of 2004–2013 winners a list entry could not be matched to. |
